...
namespace Invenio.Services.Authentication.External
{
    ...
    public partial class OpenAuthenticationService : IOpenAuthenticationService
    {
        ...
        public IList<IExternalAuthenticationMethod> LoadActiveExternalAuthenticationMethods(User User = null, int storeId = 0)
        {
        ...
        public IList<IExternalAuthenticationMethod> LoadAllExternalAuthenticationMethods(User User = null, int storeId = 0)
        {
            throw new NotImplementedException();
        }
