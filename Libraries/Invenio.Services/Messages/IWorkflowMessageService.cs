...
namespace Invenio.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        /// <returns>Queued email identifier</returns>
        //int SendOrderPaidUserNotification(Order order, int languageId,
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        //int SendOrderRefundedUserNotification(Order order, decimal refundedAmount, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        //int SendRecurringPaymentCancelledUserNotification(RecurringPayment recurringPayment, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        //int SendRecurringPaymentFailedUserNotification(RecurringPayment recurringPayment, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        //int SendNewReturnRequestUserNotification(ReturnRequest returnRequest, OrderItem orderItem, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        //int SendNewVendorAccountApplyStoreOwnerNotification(User User, Vendor vendor, int languageId);
