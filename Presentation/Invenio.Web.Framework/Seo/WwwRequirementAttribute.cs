...
namespace Invenio.Web.Framework.Seo
{
    ...
    public class WwwRequirementAttribute : FilterAttribute, IAuthorizationFilter
    {
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            //Invenio
            seoSettings.WwwRequirement = WwwRequirement.NoMatter;
            ...
            switch (seoSettings.WwwRequirement)
            {
                ...
                break;
                default:
                    throw new InvenioException("Not supported WwwRequirement parameter");
            }
        }
    }
}
