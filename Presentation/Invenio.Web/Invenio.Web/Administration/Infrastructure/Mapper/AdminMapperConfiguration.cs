...
namespace Invenio.Admin.Infrastructure.Mapper
{
    /// <summary>
    ...
    public class AdminMapperConfiguration : IMapperConfiguration
    {
        ...
        public Action<IMapperConfigurationExpression> GetConfiguration()
        {
            ...
            Action<IMapperConfigurationExpression> action = cfg =>
            {
                ...
                .ForMember(x => x.CustomProperties, mo => mo.Ignore());
                ...
                //    .ForMember(dest => dest.AssociatedUsers, mo => mo.Ignore())
                ...
                cfg.CreateMap<Order, OrderModel>()
                    .ForMember(x => x.CustomProperties, x => x.Ignore());
                ...
                //    .ForMember(dest => dest.AllowUsersToSelectTaxDisplayType_OverrideForStore, mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.ShowUsersPostCount_OverrideForStore, mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.AllowUsersToEditPosts_OverrideForStore, mo => mo.Ignore())
                //    .ForMember(dest => dest.AllowUsersToDeletePosts_OverrideForStore, mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.AllowUsersToManageSubscriptions_OverrideForStore, mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.AllowUsersToContactVendors_OverrideForStore, mo => mo.Ignore())
                //    .ForMember(dest => dest.AllowUsersToApplyForVendorAccount_OverrideForStore, mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.NotifyUserAboutShippingFromMultipleLocations_OverrideForStore,
                //        mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.DisplayShipmentEventsToUsers_OverrideForStore, mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.SearchPageAllowUsersToSelectPageSize_OverrideForStore, mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.ProductsByTagAllowUsersToSelectPageSize_OverrideForStore,
                //        mo => mo.Ignore())
                ...
                //    .ForMember(dest => dest.GeneratePdfInvoiceInUserLanguage, mo => mo.Ignore())
