    ...
    public partial class LanguageController : BaseAdminController
    {
        ...
        public virtual ActionResult Create(LanguageModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _UserActivityService.InsertActivity("AddNewLanguage", _localizationService.GetResource("ActivityLog.AddNewLanguage"), language.Id);
        ...
        public virtual ActionResult Edit(LanguageModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _UserActivityService.InsertActivity("EditLanguage", _localizationService.GetResource("ActivityLog.EditLanguage"), language.Id);
        ...
        public virtual ActionResult Delete(int id)
        {
            ...
            //activity log
            _UserActivityService.InsertActivity("DeleteLanguage", _localizationService.GetResource("ActivityLog.DeleteLanguage"), language.Id);
