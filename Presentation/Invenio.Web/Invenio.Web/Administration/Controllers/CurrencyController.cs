            ...
            if (liveRates)
            {
                try
                {
                    ...
                    if (primaryExchangeCurrency == null)
                        throw new InvenioException("Primary exchange rate currency is not set");
        ...
        public virtual ActionResult Delete(int id)
        {
            ...
            try
            {
                if (currency.Id == _currencySettings.PrimaryStoreCurrencyId)
                    throw new InvenioException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeletePrimary"));

                if (currency.Id == _currencySettings.PrimaryExchangeRateCurrencyId)
                    throw new InvenioException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeleteExchange"));
