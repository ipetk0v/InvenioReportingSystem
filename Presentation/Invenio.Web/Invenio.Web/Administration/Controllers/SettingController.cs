...
namespace Invenio.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
	{
        ...
        //        model.AllowUsersToContactVendors_OverrideForStore = _settingService.SettingExists(vendorSettings, x => x.AllowUsersToContactVendors, storeScope);
        //        model.AllowUsersToApplyForVendorAccount_OverrideForStore = _settingService.SettingExists(vendorSettings, x => x.AllowUsersToApplyForVendorAccount, storeScope);
        ...
        //        model.ShowUsersPostCount_OverrideForStore = _settingService.SettingExists(forumSettings, x => x.ShowUsersPostCount, storeScope);
        ...
        //        model.AllowUsersToEditPosts_OverrideForStore = _settingService.SettingExists(forumSettings, x => x.AllowUsersToEditPosts, storeScope);
        //        model.AllowUsersToDeletePosts_OverrideForStore = _settingService.SettingExists(forumSettings, x => x.AllowUsersToDeletePosts, storeScope);
        ...
        //        model.AllowUsersToManageSubscriptions_OverrideForStore = _settingService.SettingExists(forumSettings, x => x.AllowUsersToManageSubscriptions, storeScope);
        ...
        //        model.NotifyUserAboutShippingFromMultipleLocations_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.NotifyUserAboutShippingFromMultipleLocations, storeScope);
        ...
        //        model.DisplayShipmentEventsToUsers_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.DisplayShipmentEventsToUsers, storeScope);
        ...
        //        model.AllowUsersToSelectTaxDisplayType_OverrideForStore = _settingService.SettingExists(taxSettings, x => x.AllowUsersToSelectTaxDisplayType, storeScope);
        ...
        //        model.ShowCustomerPartNumber_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ShowCustomerPartNumber, storeScope);
        ...
        //        model.SearchPageAllowUsersToSelectPageSize_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.SearchPageAllowUsersToSelectPageSize, storeScope);
        ...
        //        model.ProductsByTagAllowUsersToSelectPageSize_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ProductsByTagAllowUsersToSelectPageSize, storeScope);
        ...
        //        model.CustomersBlockItemsToDisplay_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.CustomersBlockItemsToDisplay, storeScope);
        ...
        //    _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ShowCustomerPartNumber, model.ShowCustomerPartNumber_OverrideForStore, storeScope, false);
        ...
        //    _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.CustomersBlockItemsToDisplay, model.CustomersBlockItemsToDisplay_OverrideForStore, storeScope, false);
        ...
        //        model.CustomerThumbPictureSize_OverrideForStore = _settingService.SettingExists(mediaSettings, x => x.CustomerThumbPictureSize, storeScope);
        ...
        //    _settingService.SaveSettingOverridablePerStore(mediaSettings, x => x.CustomerThumbPictureSize, model.CustomerThumbPictureSize_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult SupplierUser()
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
            ...
            //merge settings
            var model = new SupplierUserSettingsModel();
        ...
        [HttpPost]
        public virtual ActionResult SupplierUser(SupplierUserSettingsModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
            ...
            return RedirectToAction("SupplierUser");
        }
        ...
        public virtual ActionResult GeneralCommon()
        {
            ...
            model.StoreInformationSettings.SitemapIncludeCustomers = commonSettings.SitemapIncludeCustomers;
            ...
            if (storeScope > 0)
            {
                ...
                model.StoreInformationSettings.SitemapIncludeCustomers_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.SitemapIncludeCustomers, storeScope);
        ...
        public virtual ActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            commonSettings.SitemapIncludeCustomers = model.StoreInformationSettings.SitemapIncludeCustomers;
            ...
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.SitemapIncludeCustomers, model.StoreInformationSettings.SitemapIncludeCustomers_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult ChangeEncryptionKey(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                ...
                if (String.IsNullOrEmpty(newEncryptionPrivateKey) || newEncryptionPrivateKey.Length != 16)
                    throw new InvenioException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TooShort"));

                string oldEncryptionPrivateKey = securitySettings.EncryptionKey;
                if (oldEncryptionPrivateKey == newEncryptionPrivateKey)
                    throw new InvenioException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TheSame"));
        ...
        public virtual ActionResult ToggleFullText(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                if (! _fulltextService.IsFullTextSupported())
                    throw new InvenioException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.FullTextSettings.NotSupported"));
