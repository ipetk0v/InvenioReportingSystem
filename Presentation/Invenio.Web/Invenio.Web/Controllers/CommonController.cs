...
namespace Invenio.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        //available even when navigation is not allowed
        //[PublicStoreAllowNavigation(true)]
        //public virtual ActionResult SetTaxType(int UserTaxType, string returnUrl = "")
        //{
        ...
        //    if (_workContext.CurrentUser.GetAttribute<bool>(SystemUserAttributeNames.EuCookieLawAccepted, _storeContext.CurrentStore.Id))
        //        //already accepted
        //        return Content("");
        ...
        //    //save setting
        //    _genericAttributeService.SaveAttribute(_workContext.CurrentUser, SystemUserAttributeNames.EuCookieLawAccepted, true, _storeContext.CurrentStore.Id);
