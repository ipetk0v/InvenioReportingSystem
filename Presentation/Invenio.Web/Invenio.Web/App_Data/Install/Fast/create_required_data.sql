...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (2, N'User.BackInStock', NULL, N'%Store.Name%. Back in stock notification', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %User.FullName%,
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (3, N'User.EmailValidationMessage', NULL, N'%Store.Name%. Email validation', N'<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--To activate your account <a href="%User.AccountActivationURL%">click here</a>.
--<br />
--<br />
--%Store.Name%
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (4, N'User.EmailRevalidationMessage', NULL, N'%Store.Name%. Email validation', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %User.FullName%!
--<br />
--To validate your new email address <a href="%User.EmailRevalidationURL%">click here</a>.
--<br />
--<br />
--%Store.Name%
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (5, N'User.NewPM', NULL, N'%Store.Name%. You have received a new private message', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (6, N'User.PasswordRecovery', NULL, N'%Store.Name%. Password recovery', N'<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
...
--%Store.Name%
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (7, N'User.WelcomeMessage', NULL, N'Welcome to %Store.Name%', N'We welcome you to <a href="%Store.URL%"> %Store.Name%</a>.
--<br />
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (11, N'NewUser.Notification', NULL, N'%Store.Name%. New User registration', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--A new User registered with your store. Below are the User''s details:
--<br />
...
--<br />
--<br />
--%User.FullName% has just submitted a new return request. Details are below:
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (13, N'NewReturnRequest.UserNotification', NULL, N'%Store.Name%. New return request.', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %User.FullName%!
...
--<br />
--<br />
--%User.FullName% (%User.Email%) has just submitted a new VAT number. Details are below:
--<br />
--VAT number: %User.VatNumber%
--<br />
--VAT number status: %User.VatNumberStatus%
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (18, N'OrderCancelled.UserNotification', NULL, N'%Store.Name%. Your order cancelled', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
...
--<br />
--Order Details: <a target="_blank" href="%Order.OrderURLForUser%">%Order.OrderURLForUser%</a>
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (19, N'OrderCompleted.UserNotification', NULL, N'%Store.Name%. Your order completed', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %Order.UserFullName%,
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (20, N'ShipmentDelivered.UserNotification', NULL, N'Your order from %Store.Name% has been delivered.', N'<p>
--<a href="%Store.URL%"> %Store.Name%</a>
--<br />
--<br />
--Hello %Order.UserFullName%,
...
--Order Number: %Order.OrderNumber%
--<br />
--Order Details: <a href="%Order.OrderURLForUser%" target="_blank">%Order.OrderURLForUser%</a>
--<br />
--Date Ordered: %Order.CreatedOn%
--<br />
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (21, N'OrderPlaced.UserNotification', NULL, N'Order receipt from %Store.Name%.', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %Order.UserFullName%,
...
--<br />
--<br />
--%Order.UserFullName% (%Order.UserEmail%) has just placed an order from your store. Below is the summary of the order.
--<br />
--<br />
--Order Number: %Order.OrderNumber%
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (23, N'ShipmentSent.UserNotification', NULL, N'Your order from %Store.Name% has been shipped.', N'<p>
--<a href="%Store.URL%"> %Store.Name%</a>
--<br />
--<br />
--Hello %Order.UserFullName%!,
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (27, N'ReturnRequestStatusChanged.UserNotification', NULL, N'%Store.Name%. Return request status was changed.', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %User.FullName%,
...
--<br />
--<br />
--<b><a target="_blank" href="%Product.ProductURLForUser%">%Product.Name%</a></b>
--<br />
--%Product.ShortDescription%
--<br />
--<br />
--For more info click <a target="_blank" href="%Product.ProductURLForUser%">here</a>
--<br />
--<br />
--<br />
...
--<br />
--<br />
--For more info click <a target="_blank" href="%Wishlist.URLForUser%">here</a>
--<br />
--<br />
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (30, N'User.NewOrderNote', NULL, N'%Store.Name%. New order note has been added', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %User.FullName%,
...
--"%Order.NewNoteText%".
--<br />
--<a target="_blank" href="%Order.OrderURLForUser%">%Order.OrderURLForUser%</a>
--</p>
--', 1, NULL, 0, 0, 1, 0)
...
--<br />
--<br />
--%if (%RecurringPayment.CancelAfterFailedPayment%) The last payment for the recurring payment ID=%RecurringPayment.ID% failed, so it was cancelled. endif% %if (!%RecurringPayment.CancelAfterFailedPayment%) %User.FullName% (%User.Email%) has just cancelled a recurring payment ID=%RecurringPayment.ID%. endif%
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (32, N'RecurringPaymentCancelled.UserNotification', NULL, N'%Store.Name%. Recurring payment cancelled', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %User.FullName%,
--<br />
--%if (%RecurringPayment.CancelAfterFailedPayment%) It appears your credit card didn''t go through for this recurring payment (<a href="%Order.OrderURLForUser%" target="_blank">%Order.OrderURLForUser%</a>)
--<br />
...
--</p>
--', 1, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (33, N'RecurringPaymentFailed.UserNotification', NULL, N'%Store.Name%. Last recurring payment failed', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %User.FullName%,
--<br />
--It appears your credit card didn''t go through for this recurring payment (<a href="%Order.OrderURLForUser%" target="_blank">%Order.OrderURLForUser%</a>)
...
--<br />
--<br />
--%User.FullName% (%User.Email%) has just placed an order.
--<br />
--<br />
--Order Number: %Order.OrderNumber%
--<br />
...
--</p>
--', 0, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (35, N'OrderRefunded.UserNotification', NULL, N'%Store.Name%. Order #%Order.OrderNumber% refunded', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %Order.UserFullName%,
...
--</p>
--', 0, NULL, 0, 0, 1, 0)
--INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (38, N'OrderPaid.UserNotification', NULL, N'%Store.Name%. Order #%Order.OrderNumber% paid', N'<p>
--<a href="%Store.URL%">%Store.Name%</a>
--<br />
--<br />
--Hello %Order.UserFullName%,
...
--<br />
--<br />
--%User.FullName% (%User.Email%) has just submitted for a vendor account. Details are below:
--<br />
...
--SET IDENTITY_INSERT [dbo].[CustomerTemplate] ON 

--INSERT [dbo].[CustomerTemplate] ([Id], [Name], [ViewPath], [DisplayOrder]) VALUES (1, N'Products in Grid or Lines', N'CustomerTemplate.ProductsInGridOrLines', 1)
--SET IDENTITY_INSERT [dbo].[CustomerTemplate] OFF
--GO
...
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (10, N'AddNewUser', N'Add a new User', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (11, N'AddNewUserAttribute', N'Add a new User attribute', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (12, N'AddNewUserAttributeValue', N'Add a new User attribute value', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (13, N'AddNewUserRole', N'Add a new User role', 1)
...
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (18, N'AddNewCustomer', N'Add a new Customer', 1)
...
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (43, N'DeleteUser', N'Delete a User', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (44, N'DeleteUserAttribute', N'Delete a User attribute', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (45, N'DeleteUserAttributeValue', N'Delete a User attribute value', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (46, N'DeleteUserRole', N'Delete a User role', 1)
...
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (51, N'DeleteCustomer', N'Delete a Customer', 1)
...
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (80, N'EditUser', N'Edit a User', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (81, N'EditUserAttribute', N'Edit a User attribute', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (82, N'EditUserAttributeValue', N'Edit a User attribute value', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (83, N'EditUserRole', N'Edit a User role', 1)
...
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (88, N'EditCustomer', N'Edit a Customer', 1)
...
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (109, N'Impersonation.Started', N'User impersonation session. Started', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (110, N'Impersonation.Finished', N'User impersonation session. Finished', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (111, N'ImportCategories', N'Categories were imported', 1)
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (112, N'ImportCustomers', N'Customers were imported', 1)
...
--INSERT [dbo].[ActivityLogType] ([Id], [SystemKeyword], [Name], [Enabled]) VALUES (118, N'PublicStore.ViewCustomer', N'Public store. View a Customer', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (14, N'commonsettings.sitemapincludeCustomers', N'True', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (61, N'producteditorsettings.allowUserreviews', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (62, N'producteditorsettings.producttags', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (63, N'producteditorsettings.Customerpartnumber', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (73, N'producteditorsettings.Userentersprice', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (117, N'producteditorsettings.Customers', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (124, N'catalogsettings.showCustomerpartnumber', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (159, N'catalogsettings.searchpageallowUserstoselectpagesize', N'True', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (166, N'catalogsettings.productsbytagallowUserstoselectpagesize', N'True', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (178, N'catalogsettings.Customersblockitemstodisplay', N'2', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (187, N'catalogsettings.defaultCustomerpagesizeoptions', N'6, 3, 9', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (188, N'catalogsettings.defaultCustomerpagesize', N'6', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (201, N'Usersettings.usernamesenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (202, N'Usersettings.checkusernameavailabilityenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (203, N'Usersettings.allowuserstochangeusernames', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (204, N'Usersettings.defaultpasswordformat', N'Hashed', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (205, N'Usersettings.hashedpasswordformat', N'SHA1', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (206, N'Usersettings.passwordminlength', N'6', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (207, N'Usersettings.unduplicatedpasswordsnumber', N'4', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (208, N'Usersettings.passwordrecoverylinkdaysvalid', N'7', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (209, N'Usersettings.passwordlifetime', N'90', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (210, N'Usersettings.failedpasswordallowedattempts', N'0', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (211, N'Usersettings.failedpasswordlockoutminutes', N'30', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (212, N'Usersettings.userregistrationtype', N'Standard', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (213, N'Usersettings.allowUserstouploadavatars', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (214, N'Usersettings.avatarmaximumsizebytes', N'20000', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (215, N'Usersettings.defaultavatarenabled', N'True', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (216, N'Usersettings.showUserslocation', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (217, N'Usersettings.showUsersjoindate', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (218, N'Usersettings.allowviewingprofiles', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (219, N'Usersettings.notifynewUserregistration', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (220, N'Usersettings.hidedownloadableproductstab', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (221, N'Usersettings.hidebackinstocksubscriptionstab', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (222, N'Usersettings.downloadableproductsvalidateuser', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (223, N'Usersettings.Usernameformat', N'ShowFirstName', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (224, N'Usersettings.newsletterenabled', N'True', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (225, N'Usersettings.newslettertickedbydefault', N'True', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (226, N'Usersettings.hidenewsletterblock', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (227, N'Usersettings.newsletterblockallowtounsubscribe', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (228, N'Usersettings.onlineUserminutes', N'20', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (229, N'Usersettings.storelastvisitedpage', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (230, N'Usersettings.suffixdeletedUsers', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (231, N'Usersettings.enteringemailtwice', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (232, N'Usersettings.requireregistrationfordownloadableproducts', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (233, N'Usersettings.deleteguesttaskolderthanminutes', N'1440', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (234, N'Usersettings.genderenabled', N'True', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (235, N'Usersettings.dateofbirthenabled', N'True', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (236, N'Usersettings.dateofbirthrequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (237, N'Usersettings.dateofbirthminimumage', N'', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (238, N'Usersettings.companyenabled', N'True', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (239, N'Usersettings.companyrequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (240, N'Usersettings.streetaddressenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (241, N'Usersettings.streetaddressrequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (242, N'Usersettings.streetaddress2enabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (243, N'Usersettings.streetaddress2required', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (244, N'Usersettings.zippostalcodeenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (245, N'Usersettings.zippostalcoderequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (246, N'Usersettings.cityenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (247, N'Usersettings.cityrequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (248, N'Usersettings.countryenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (249, N'Usersettings.countryrequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (250, N'Usersettings.stateprovinceenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (251, N'Usersettings.stateprovincerequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (252, N'Usersettings.phoneenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (253, N'Usersettings.phonerequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (254, N'Usersettings.faxenabled', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (255, N'Usersettings.faxrequired', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (256, N'Usersettings.acceptprivacypolicyenabled', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (279, N'mediasettings.Customerthumbpicturesize', N'420', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (295, N'storeinformationsettings.allowUsertoselecttheme', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (364, N'ordersettings.generatepdfinvoiceinUserlanguage', N'True', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (391, N'shippingsettings.notifyUseraboutshippingfrommultiplelocations', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (396, N'shippingsettings.displayshipmenteventstoUsers', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (418, N'taxsettings.allowUserstoselecttaxdisplaytype', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (437, N'datetimesettings.allowUserstosettimezone', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (457, N'forumsettings.allowUserstoeditposts', N'False', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (458, N'forumsettings.allowUserstomanagesubscriptions', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (461, N'forumsettings.allowUserstodeleteposts', N'False', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (471, N'forumsettings.latestUserpostspagesize', N'10', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (472, N'forumsettings.showUserspostcount', N'True', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (491, N'vendorsettings.allowUserstocontactvendors', N'True', 0)
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (492, N'vendorsettings.allowUserstoapplyforvendoraccount', N'True', 0)
...
INSERT [dbo].[Setting] ([Id], [Name], [Value], [StoreId]) VALUES (503, N'displaydefaultmenuitemsettings.displayUserinfomenuitem', N'False', 0)
...
INSERT [dbo].[ScheduleTask] ([Id], [Name], [Seconds], [Type], [Enabled], [StopOnError], [LeasedByMachineName], [LeasedUntilUtc], [LastStartUtc], [LastEndUtc], [LastSuccessUtc]) VALUES (1, N'Send emails', 60, N'Invenio.Services.Messages.QueuedMessagesSendTask, Invenio.Services', 1, 0, NULL, NULL, NULL, NULL, NULL)
INSERT [dbo].[ScheduleTask] ([Id], [Name], [Seconds], [Type], [Enabled], [StopOnError], [LeasedByMachineName], [LeasedUntilUtc], [LastStartUtc], [LastEndUtc], [LastSuccessUtc]) VALUES (2, N'Keep alive', 300, N'Invenio.Services.Common.KeepAliveTask, Invenio.Services', 1, 0, NULL, NULL, NULL, NULL, NULL)
INSERT [dbo].[ScheduleTask] ([Id], [Name], [Seconds], [Type], [Enabled], [StopOnError], [LeasedByMachineName], [LeasedUntilUtc], [LastStartUtc], [LastEndUtc], [LastSuccessUtc]) VALUES (3, N'Delete guests', 600, N'Invenio.Services.Users.DeleteGuestsTask, Invenio.Services', 1, 0, NULL, NULL, NULL, NULL, NULL)
INSERT [dbo].[ScheduleTask] ([Id], [Name], [Seconds], [Type], [Enabled], [StopOnError], [LeasedByMachineName], [LeasedUntilUtc], [LastStartUtc], [LastEndUtc], [LastSuccessUtc]) VALUES (4, N'Clear cache', 600, N'Invenio.Services.Caching.ClearCacheTask, Invenio.Services', 0, 0, NULL, NULL, NULL, NULL, NULL)
INSERT [dbo].[ScheduleTask] ([Id], [Name], [Seconds], [Type], [Enabled], [StopOnError], [LeasedByMachineName], [LeasedUntilUtc], [LastStartUtc], [LastEndUtc], [LastSuccessUtc]) VALUES (5, N'Clear log', 3600, N'Invenio.Services.Logging.ClearLogTask, Invenio.Services', 0, 0, NULL, NULL, NULL, NULL, NULL)
INSERT [dbo].[ScheduleTask] ([Id], [Name], [Seconds], [Type], [Enabled], [StopOnError], [LeasedByMachineName], [LeasedUntilUtc], [LastStartUtc], [LastEndUtc], [LastSuccessUtc]) VALUES (6, N'Update currency exchange rates', 3600, N'Invenio.Services.Directory.UpdateExchangeRateTask, Invenio.Services', 1, 0, NULL, NULL, NULL, NULL, NULL)
...
INSERT [dbo].[UserPassword] ([Id], [UserId], [Password], [PasswordFormatId], [PasswordSalt], [CreatedOnUtc]) VALUES (1, 1, N'64F95333B716AC9BEF6B2D7262CE82C42C454F82', 1, N'YpDOuGI=', CAST(N'2017-03-13T11:19:40.080' AS DateTime))
INSERT [dbo].[UserPassword] ([Id], [UserId], [Password], [PasswordFormatId], [PasswordSalt], [CreatedOnUtc]) VALUES (2, 2, N'123456', 0, N'', CAST(N'2017-03-13T11:19:40.113' AS DateTime))
INSERT [dbo].[UserPassword] ([Id], [UserId], [Password], [PasswordFormatId], [PasswordSalt], [CreatedOnUtc]) VALUES (3, 3, N'123456', 0, N'', CAST(N'2017-03-13T11:19:40.133' AS DateTime))
INSERT [dbo].[UserPassword] ([Id], [UserId], [Password], [PasswordFormatId], [PasswordSalt], [CreatedOnUtc]) VALUES (4, 4, N'123456', 0, N'', CAST(N'2017-03-13T11:19:40.153' AS DateTime))
INSERT [dbo].[UserPassword] ([Id], [UserId], [Password], [PasswordFormatId], [PasswordSalt], [CreatedOnUtc]) VALUES (5, 5, N'123456', 0, N'', CAST(N'2017-03-13T11:19:40.173' AS DateTime))
INSERT [dbo].[UserPassword] ([Id], [UserId], [Password], [PasswordFormatId], [PasswordSalt], [CreatedOnUtc]) VALUES (6, 6, N'123456', 0, N'', CAST(N'2017-03-13T11:19:40.200' AS DateTime))
...
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (3, 2, N'User', N'FirstName', N'Steve', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (4, 2, N'User', N'LastName', N'Gates', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (5, 3, N'User', N'FirstName', N'Arthur', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (6, 3, N'User', N'LastName', N'Holmes', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (7, 4, N'User', N'FirstName', N'James', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (8, 4, N'User', N'LastName', N'Pan', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (9, 5, N'User', N'FirstName', N'Brenda', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (10, 5, N'User', N'LastName', N'Lindgren', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (11, 6, N'User', N'FirstName', N'Victoria', 0)
INSERT [dbo].[GenericAttribute] ([Id], [EntityId], [KeyGroup], [Key], [Value], [StoreId]) VALUES (12, 6, N'User', N'LastName', N'Terces', 0)
...
INSERT [dbo].[UserRole] ([Id], [Name], [FreeShipping], [TaxExempt], [Active], [IsSystemRole], [SystemName], [EnablePasswordLifetime], [PurchasedWithProductId]) VALUES (1, N'Administrators', 0, 0, 1, 1, N'Administrators', 0, 0)
INSERT [dbo].[UserRole] ([Id], [Name], [FreeShipping], [TaxExempt], [Active], [IsSystemRole], [SystemName], [EnablePasswordLifetime], [PurchasedWithProductId]) VALUES (2, N'Forum Moderators', 0, 0, 1, 1, N'ForumModerators', 0, 0)
INSERT [dbo].[UserRole] ([Id], [Name], [FreeShipping], [TaxExempt], [Active], [IsSystemRole], [SystemName], [EnablePasswordLifetime], [PurchasedWithProductId]) VALUES (3, N'Registered', 0, 0, 1, 1, N'Registered', 0, 0)
INSERT [dbo].[UserRole] ([Id], [Name], [FreeShipping], [TaxExempt], [Active], [IsSystemRole], [SystemName], [EnablePasswordLifetime], [PurchasedWithProductId]) VALUES (4, N'Guests', 0, 0, 1, 1, N'Guests', 0, 0)
INSERT [dbo].[UserRole] ([Id], [Name], [FreeShipping], [TaxExempt], [Active], [IsSystemRole], [SystemName], [EnablePasswordLifetime], [PurchasedWithProductId]) VALUES (5, N'Vendors', 0, 0, 1, 1, N'Vendors', 0, 0)
